function [iters, dec_seq, success_dec, synd,APP] = EMS1(LLR_2, max_iter, mul_mat, add_mat, div_mat,...
    h,str_cn_vn, dc,str_vn_cn,dv, nm, nc, c2v_comp_fact, comp_ECN)
% c2v_comp = 50.33;
M = size(h,1);
N = size(h,2);
q = size(LLR_2,2);
...
while iter<max_iter
    iter = iter+1;
Mv2c = VNU(N, dv, Mv2c, Mc2v, LLR_2, str_vn_cn, str_cn_vn);
