...
h = load('/home/matlab-runner/abdallah_files/NGDSF QAM with conditional probability/results/Non_Binary_RQAM_GD_SymboleFlipping_204.102.3.6.16_dated_2024_09_16_02_51_17.mat');
...
legend({'BER: EMS nm=4 iter=15';'BER: EMS nm=8 iter=15';...
    ...
    'BER: qam NB-GD-SymbFlip 4000 iters +'}, 'Location', 'southwest');
xlabel('SNR (dB)')
ylabel('BER')