function decw = polar_nb_dec_with_perm(gf_coef,add_mat, mul_mat, div_mat,per0,per0_inv,  LLR,Ic,UIc, M,N,q,n )
...
while i>0
    ...
    elseif stat_v{i+1}(2*j-1)
        ...
        temp0 = sqz(L(i,ii1,:),1);
        if i==1
            temp1 = VNu_perm(V(i+1,ii2), temp0 , q, add_mat, per0);
        else
        ...
        temp0 = sqz(L(i,ii1,:),1);
        if i==1
            temp1 = CNu_perm(temp0', gf_coef(ii2,n-i+1), add_mat, div_mat,per0_inv)';
        else
