...
SNRvals           = 3:0.5:4.0;  # SNR values to simulate
F                 = 50;      # Number of frame errors to observe
Fchan             = 5;    # Number of channel frames to generate per batch
R                 = 0.8412;  # code rate
T                 = 1000;    # Max iterations for decoding
w                 = 0.166;   # Syndrome weight parameter
Ymax              = 2.95;    # Channel sample saturation magnitude
theta             = -0.55;   # Flipping threshold
