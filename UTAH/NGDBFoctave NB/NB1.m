...
Ebnos           = 4.2;  % SNR values to simulate
...
for sdx=1:snr_cnt
    ...
    while (keepGoing)
        ...
        [d, failed, Sgf, Sb, E, seqb, seqgf, iters] = decodeGDBFvecNB1(p, str_cn_vn,mul_mat, add_mat, y,hl, h, N, T, w, theta, nsigma);
