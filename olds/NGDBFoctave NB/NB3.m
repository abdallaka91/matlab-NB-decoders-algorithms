...
parf = 160;
T		= 1000;
Ebnos           = 3.75:0.25:5;  % SNR values to simulate
...
for sdx=1:snr_cnt
    ...
    while (keepGoing)
        ...
        parfor pp=1 :parf
            ...
            [~, failed__, ~, ~, E__, ~, seqgf__, iters__] = decodeGDBFvecNB3(p,pw, h_arr,str_cn_vn,dc,dv, mul_mat, add_mat, y,hl, h, N, T, w, theta,mnk, nsigma);
