function [d, failed_mx, Sgfo, Sbo, E, seqb, seqgf, l]  = decodeGDBFvecNB5(p,pw, h_arr,str_cn_vn,...
    dc,dv, mul_mat, add_mat,y,hl, h, N, T, w, theta, mnk,nsigma,dev_hamm1,dev_hamm2)
theta0=theta;
stk=0;
M=size(h,1);
Nb = length(y);
