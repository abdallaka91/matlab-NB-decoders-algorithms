...
parf = 24;
Ebnos           = 4:0.2:4.8;  % SNR values to simulate
...
for sdx=1:snr_cnt
    ...
    while (keepGoing)
        ...
        parfor pp=1 :parf
            ...
            [~, failed__, ~, ~, E__, ~, seqgf__, iters__] = decodeGDBFvecNB5(p,pw, h_arr,str_cn_vn,dc,dv,...
                mul_mat, add_mat, y,hl, h, N, T, w, theta,mnk,nsigma,dev_hamm1, dev_hamm2, sngl_VN_th);
