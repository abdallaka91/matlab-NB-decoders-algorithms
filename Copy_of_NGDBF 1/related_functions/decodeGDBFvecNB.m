function [d, failed_mx, Sgfo, Sbo, E, seqb, seqgf, l, succ_ref, i11]  = decodeGDBFvecNB(p,pw, h_arr,str_cn_vn,...
    dc,dv, mul_mat, add_mat,y,hl, h, N, T, w, theta, mnk,regns, nsigma,dev_hamm1,dev_hamm2, sngl_VN, max_max_l)
isrefrsh = 0;
succ_ref=0;
theta0=theta(1);
stk=0;
