...
a = load(fullfile(pth6, '204.102.3.6.16_2024_05_29_17_49_10.mat'));
...
figure;
semilogy(a.ebn0, a.BERstat','o-' ,b.ebn0, b.FERstat','o-', c.ebn0, c.FERstat','o-')
grid on
xlim([0 6])
ylim([1e-7 1e-0])
legend({'FER without perturbation', 'FER with perturbation', '4 attempts'})
