function [iter, dec_seq, success_dec] = presorted_MVSF_0(LLR_2, max_iter, mul_mat, add_mat, div_mat,...
...
while iter<max_iter
    ...
    for i = 1 : M
        ...
        for l = 1 : L
            ...
            non_dev_loc0 = find(dev_pos_i11==0);
            msg_dev_deg_i2j0(:,l) = dc(i)-length(non_dev_loc0);
            non_dev_loc = 1:dc(i);
            ...
            for j2 = 1 : dc(i)
                ...
                if msg_dev_deg_i2j0(addr,l)<length(v_weights)
